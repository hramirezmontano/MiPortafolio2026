          ...
          <%@ page import="java.util.List" %>
            ...
            <% ExperienciaDAO expDAO=new ExperienciaDAO(); List<Experiencia> listaExperiencias = expDAO.obtenerTodas();
              ...
              List<Proyecto> listaProyectos = proyDAO.obtenerTodos();
                ...
                <%-- git add . git commit -m "Descripción clara de lo que modificaste" git push --%>
                          ...
                          <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="service-item position-relative">
                                ...
                                <p>Desarrollo e integración de módulos de atención y consulta para plataformas bancarias
                                  (Banco Estado), optimizando la seguridad y fluidez en las transacciones de los
                                  usuarios.
                                </p>
                              </div>
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="service-item position-relative">
                                ...
                                <p>Implementación y mantenimiento evolutivo de software a medida para la automatización
                                  de
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                              <div class="service-item position-relative">
                                ...
                                <p>Desarrollo de interfaz de usuario responsiva conectada con arquitecturas backend
                                  robustas, garantizando una navegación intuitiva y una rápida respuesta del servidor.
                                </p>
                              </div>
                            </div><!-- Fin Section Proyectos -->
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                              <div class="service-item position-relative">
                                ...
                                <p>Reestructuración de consultas SQL complejas y optimización de base de datos
                                  relacionales, logrando una reducción significativa en los tiempos de carga del
                                  sistema.
                                </p>
